<template>
  <div>
    <h3 class="pa-4">BCX Exa Demo Website</h3>
    <p class="pa-4">
      Thanks for looking at our post, some fun to be had below. Right & Left
      Click to see balls bounce around
    </p>
    <div id="abc"></div>
  </div>
</template>
